...
import 'package:eyadty_app/features/promotions/presentation/widgets/new_campaing_step_2_column.dart';
...
class NewCampaginStep2 extends StatelessWidget {
  const NewCampaginStep2({super.key});
      ...
      children: [
        ...
        Positioned(
          ...
          child: NewCampaignBottomOptions(
            nextOnPressed: () {
              context.push(Routes.newCampaign3);
            },
          ),
        )
      ],
