...
import 'package:eyadty_app/features/promotions/presentation/widgets/new_campaing_step_1_column.dart';
...
class NewCampaginStep1 extends StatelessWidget {
  const NewCampaginStep1({super.key});
      ...
      children: [
        CustomScrollView(
          ...
          slivers: [
            ...
            SliverFillRemaining(
              hasScrollBody: false,
              child: SharedParentContainer(child: NewCampaingStep1Column()),
            ),
            SliverToBoxAdapter(
        ...
        Positioned(
          ...
          child: NewCampaignBottomOptions(
            nextOnPressed: () {
              context.push(Routes.newCampaign2);
            },
          ),
        )
      ],
